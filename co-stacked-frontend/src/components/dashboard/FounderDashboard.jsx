...
import { Bell, Briefcase, Search, Rocket, UserPlus, Eye } from 'lucide-react';
              ...
              return (
                <Card key={project._id} className={styles.projectCard}>
                  <div>
                    ...
                    {isBoostedActive
                      ? <p className={styles.boostStatus}><Rocket size={14} /> Boosted until {formatDate(project.boostExpiresAt)}</p>
