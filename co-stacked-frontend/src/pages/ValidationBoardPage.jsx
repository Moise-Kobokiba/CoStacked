  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        ...
        <Link 
          to="/validation-board/create" 
          className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg inline-flex items-center gap-2 transition-transform active:scale-95 shadow-lg shadow-blue-500/25"
        >
          <PlusCircle size={20} />
          Post Your Idea
        </Link>
              ...
              {posts.map(post => {
                ...
                return (
                  <div 
                    ...
                    className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 hover:shadow-xl hover:border-blue-500/30 transition-all group flex flex-col h-full cursor-pointer"
                  >
