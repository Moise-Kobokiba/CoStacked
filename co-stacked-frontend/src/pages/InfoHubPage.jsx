...
export const InfoHubPage = () => {
    ...
    const handleSubmitResource = () => {
        ...
        window.location.href = `mailto:collab@costacked.co.za?subject=${subject}&body=${body}`;
    };
            ...
            <main className={styles.mainContent}>
                ...
                <aside className={styles.sidebar}>
                        ...
                        {articles.slice(0, 3).map(guide => (
                            ...
                            >
                                ...
                                <div className={styles.sideMeta}>
                                    <span><Clock size={14} /> {guide.readTime || '5 min'}</span>
                    ...
                    <div className={styles.newsletterCard}>
                        ...
                        <p>Join 2k+ founders getting weekly startup resources.</p>
