    ...
    <div className={styles.pageContainer}>
      <div className={styles.content}>
        ...
        <section>
          ...
          <p>Co-Stacked is a platform for sharing ideas. When you connect with another user, you may be exposed to their confidential information. The <strong>Non-Disclosure Agreement (NDA)</strong> presented before you connect governs the confidentiality of this information.</p>
          <p>Co-Stacked does not claim ownership rights in the project ideas or content you post. The intellectual property of projects remains with the original Founder or as agreed between collaborating parties.</p>
          <p>The Co-Stacked platform itself, including its design, features, and functionality, is owned by Co-Stacked and is protected by copyright, trademark, and other intellectual property laws.</p>
        </section>
        ...
        <section>
          ...
          <p>In no event shall Co-Stacked, nor its directors, employees, or agents, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:</p>
          <ul>
          ...
          <p><strong>Disclaimer:</strong> Co-Stacked does not vet users or projects. We are not responsible for the conduct of any user of our service. You are solely responsible for your interactions with other users and any agreements you enter into with them.</p>
        </section>

        <section>
          <h2>9. Indemnification</h2>
          <p>You agree to defend, indemnify, and hold harmless Co-Stacked and its affiliates from and against any claims, damages, obligations, losses, liabilities, costs, or debt arising from your use of the Service or violation of these Terms.</p>
        </section>
        ...
        <section>
          ...
          <p><strong>Email:</strong> legal@co-stacked.com</p>
        </section>
      </div>
    </div>
  );
